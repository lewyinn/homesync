...
export default function ProductSection() {
    ...
    const filteredProducts = activeCategory === ALL
        ? products.slice(0, 3)
        : products.filter(p => p.type === activeCategory).slice(0, 3);
                        ...
                        >
                            ...
                            <div className="p-5 flex flex-col flex-1">
                                ...
                                <div className="mt-auto pt-4 flex items-center justify-between">
                                    <Link href={`/products/${p.slug}`} className="px-4 py-2 rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-800 hover:text-neutral-200 transition text-sm font-semibold">
                                        See More →
                                    </Link>
